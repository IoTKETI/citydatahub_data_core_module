...
-- 2024-01-15
ALTER TABLE DATA_SERVICE_BROKER.CSOURCE_REGISTRATION_BASE ADD COLUMN MODE VARCHAR(20);
ALTER TABLE DATA_SERVICE_BROKER.CSOURCE_REGISTRATION_BASE ADD COLUMN OPERATIONS VARCHAR(50);
