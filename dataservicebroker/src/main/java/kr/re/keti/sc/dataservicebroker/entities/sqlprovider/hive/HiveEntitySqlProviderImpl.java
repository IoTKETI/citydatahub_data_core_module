...
public class HiveEntitySqlProviderImpl {
    ...
    for (int i = 0; i < entityDaoVOList.size(); i++) {
      ...
      if (dbColumnInfoVOMap != null) {
        ...
        valueBuilder
          ...
          .append(
            entityDaoVO.get(
              DataServiceBrokerCode.DefaultAttributeKey.ID.getCode()
            )
          )
          .append("'")
        ...
        valueBuilder
          ...
          .append(
            entityDaoVO.get(
              DataServiceBrokerCode.DefaultAttributeKey.DATASET_ID.getCode()
            )
          )
          .append("'")
          .append(COMMA_WITH_SPACE);
        valueBuilder
          .append("from_utc_timestamp('")
          .append(
            DateUtil.dateToDbFormatString(
              (Date) entityDaoVO.get(
                DataServiceBrokerCode.DefaultAttributeKey.CREATED_AT.getCode()
              )
            )
          )
          .append("', 'UTC')")
        ...
        compareColumnList.removeIf(
          e -> e.toUpperCase().equalsIgnoreCase("DATASET_ID")
        );
        compareColumnList.removeIf(
          e -> e.toUpperCase().equalsIgnoreCase("CREATED_AT")
        );
        compareColumnList.removeIf(
          e -> e.toUpperCase().equalsIgnoreCase("MODIFIED_AT")
        );
        ...
        for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
          ...
          compareColumnList.removeIf(
            e -> e.toUpperCase().equalsIgnoreCase(columnName.toUpperCase())
          );

          if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
            ArrayList<String> parameterList = (ArrayList) entityDaoVO.get(
              daoAttributeId
            );
            ...
            ArrayList<Integer> parameterList = (ArrayList) entityDaoVO.get(
              daoAttributeId
            );
            ...
            ArrayList<Double> parameterList = (ArrayList) entityDaoVO.get(
              daoAttributeId
            );
            ...
            tableColumns.replaceAll(
              e ->
                (e.equals(columnName))
                  ? "ST_ARRAYDOUBLE(" + columnName + ")"
                  : e
            );
          } else if (dbColumnType == DbColumnType.ARRAY_TIMESTAMP) {
            ArrayList<Date> parameterList = (ArrayList) entityDaoVO.get(
              daoAttributeId
            );
            ...
            for (Date parameter : parameterList) {
              if (parameter != null) {
                isNotNull = true;
                str
                  .append(DateUtil.dateToDbFormatString(parameter))
                  .append(",");
              }
            }
            ...
            tableColumns.replaceAll(
              e ->
                (e.equals(columnName))
                  ? "ST_ARRAYTIMESTAMP(" + columnName + ")"
                  : e
            );
          } else if (dbColumnType == DbColumnType.ARRAY_BOOLEAN) {
            ArrayList<Boolean> parameterList = (ArrayList) entityDaoVO.get(
              daoAttributeId
            );
            ...
            valueBuilder
              .append("'")
              .append(entityDaoVO.get(daoAttributeId))
              .append("'")
              .append(COMMA_WITH_SPACE);
            ...
            tableColumns.replaceAll(
              e ->
                (e.equalsIgnoreCase(columnName))
                  ? "ST_AsGeoJson(ST_Transform(ST_FlipCoordinates(ST_GeomFromGeoJSON(" +
                  columnName +
                  ")), 'epsg:4326','epsg:3857'))"
                  : e
            );
  ...
  public String create(CommonEntityDaoVO entityDaoVO) {
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      valueBuilder
        .append("#{")
        .append(DataServiceBrokerCode.DefaultAttributeKey.ID.getCode())
        .append("}")
        .append(COMMA_WITH_SPACE);
      valueBuilder
        .append("#{")
        .append(DataServiceBrokerCode.DefaultAttributeKey.DATASET_ID.getCode())
        .append("}")
        .append(COMMA_WITH_SPACE);
      valueBuilder
        .append("from_utc_timestamp(#{")
      ...
      valueBuilder
        .append("from_utc_timestamp(#{")
        .append(DataServiceBrokerCode.DefaultAttributeKey.MODIFIED_AT.getCode())
        .append("}, 'UTC')")
        .append(COMMA_WITH_SPACE);
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        ...
        if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
          valueBuilder
            ...
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(StringArrayListTypeHandler.class.getName())
            .append("}, ',')")
            .append(COMMA_WITH_SPACE);
        } else if (dbColumnType == DbColumnType.ARRAY_INTEGER) {
          valueBuilder
            ...
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(HiveIntegerArrayListTypeHandler.class.getName())
            .append("}, ',')")
            .append(COMMA_WITH_SPACE);
          tableColumns.replaceAll(
            e -> (e.equals(columnName)) ? "ST_ARRAYINT(" + columnName + ")" : e
          );
        } else if (dbColumnType == DbColumnType.ARRAY_FLOAT) {
          valueBuilder
            .append("split(#{")
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(HiveDoubleArrayListTypeHandler.class.getName())
            .append("}, ',')")
            .append(COMMA_WITH_SPACE);
          tableColumns.replaceAll(
            e ->
          ...
          valueBuilder
            ...
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(HiveDateArrayListTypeHandler.class.getName())
            .append("}, ',')")
            .append(COMMA_WITH_SPACE);
          tableColumns.replaceAll(
            e ->
          ...
          valueBuilder
            ...
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(HiveBooleanArrayListTypeHandler.class.getName())
            .append("}, ',')")
            .append(COMMA_WITH_SPACE);
          tableColumns.replaceAll(
            e ->
  ...
  public String replaceAttr(CommonEntityDaoVO entityDaoVO) {
    ...
    sql
      .append("MERGE INTO")
      .append(SPACE)
      .append(entityDaoVO.getDbTableName())
      .append(SPACE)
      .append("as target")
      .append(SPACE);
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      update
        .append("MODIFIED_AT = source.MODIFIED_AT")
        .append(COMMA_WITH_SPACE);
      ...
      if (
        ...
        update
          .append("DATASET_ID = source.DATASET_ID")
          .append(COMMA_WITH_SPACE);
      }
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        ...
        if (dbColumnType == DbColumnType.VARCHAR) {
          select
            .append("#{" + daoAttributeId + ", jdbcType=VARCHAR} as ")
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        } else if (dbColumnType == DbColumnType.INTEGER) {
          select
            .append("#{" + daoAttributeId + ", jdbcType=INTEGER} as ")
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        } else if (dbColumnType == DbColumnType.FLOAT) {
          select
            .append("#{" + daoAttributeId + ", jdbcType=FLOAT} as ")
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        } else if (dbColumnType == DbColumnType.BOOLEAN) {
          select
          ...
          select
            .append(
              ...
              daoAttributeId +
              ", typeHandler=" +
              StringArrayListTypeHandler.class.getName() +
              ", jdbcType=ARRAY}, ',') as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
          ...
          select
            .append(
              ...
              daoAttributeId +
              ", typeHandler=" +
              HiveIntegerArrayListTypeHandler.class.getName() +
              ", jdbcType=ARRAY}, ',')) as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
          ...
          select
            .append(
              "ST_ARRAYDOUBLE(split(#{" +
              daoAttributeId +
              ", typeHandler=" +
              HiveDoubleArrayListTypeHandler.class.getName() +
              ", jdbcType=ARRAY}, ',')) as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
          ...
          select
            .append(
              "ST_ARRAYTIMESTAMP(split(#{" +
              daoAttributeId +
              ", typeHandler=" +
              HiveDateArrayListTypeHandler.class.getName() +
              ", jdbcType=ARRAY}, ',')) as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
          ...
          select
            .append("#{" + daoAttributeId + ", jdbcType=TIMESTAMP} as ")
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        } else if (dbColumnType == DbColumnType.GEOMETRY_4326) {
          select
            .append(
              "ST_AsGeoJson(ST_GeomFromGeoJSON(#{" + daoAttributeId + "})) as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
          select
          ...
          select
            .append(
              "ST_AsGeoJson(ST_Transform(ST_FlipCoordinates(ST_GeomFromGeoJSON(#{" +
              daoAttributeId +
              "})), 'epsg:4326','epsg:3857')) as "
            )
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        } else {
          select
            .append("#{" + daoAttributeId + "} as ")
            .append(columnName)
            .append(COMMA_WITH_SPACE);
        }
  ...
  public String replaceAttrHBase(CommonEntityDaoVO entityDaoVO) {
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      tableColumns.replaceAll(
        e -> (e.equals("MODIFIED_AT")) ? "NEW_MODIFIED_AT" : e
      );
      ...
      if (
        ...
        tableColumns.replaceAll(
          e -> (e.equals("DATASET_ID")) ? "NEW_DATASET_ID" : e
        );
      }
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        ...
        tableColumns.replaceAll(
          e ->
            (e.equals(dbColumnInfoVO.getColumnName()))
              ? e.contains("_4326")
        ...
        tableColumns.replaceAll(
          e ->
            (e.equals(dbColumnInfoVO.getColumnName() + "_idx"))
              ? "ST_DISKINDEX(ST_asText(ST_GeomFromGeoJSON(" +
              "NEW_" +
              dbColumnInfoVO.getColumnName() +
              ")))"
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      sql
        .append(" AS ")
        .append("(")
        .append(String.join(COMMA_WITH_SPACE, updateColumns))
        .append(");");
    }
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        ...
        if (dbColumnType == DbColumnType.VARCHAR) {
          ...
          sql
            .append("COALESCE(#{")
            .append(daoAttributeId)
            .append(", jdbcType=DOUBLE})");
        } else if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
          sql
            .append("COALESCE(array(")
            .append("#{")
            .append(daoAttributeId)
            .append(", typeHandler=")
            .append(StringArrayListTypeHandler.class.getName())
          ...
          sql
            .append("COALESCE(from_utc_timestamp(#{")
            .append(daoAttributeId)
            .append("}, 'UTC'))");
        } else if (dbColumnType == DbColumnType.GEOMETRY_4326) { // 컬럼에 4326을 포함하는 경우, Geometry로 간주하여 처리
          ...
          for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
            ...
            if (dbColumnType == DbColumnType.VARCHAR) {
              ...
              SET(
                ...
                " = CASE WHEN " +
                columnName +
                " IS NOT NULL THEN ST_SetSRID(ST_GeomFromGeoJSON(#{" +
                daoAttributeId +
                "}), 4326) END"
              );
            } else if (dbColumnType == DbColumnType.GEOMETRY_3857) {
  ...
  public String deleteHist(CommonEntityDaoVO entityDaoVO) {
    StringBuilder sql = new StringBuilder();
    String tableName = StringUtil.removeSpecialCharAndLower(
      entityDaoVO.getDbTableName() + Constants.PARTIAL_HIST_TABLE_PREFIX
    );
  ...
  public String deleteFullHist(CommonEntityDaoVO entityDaoVO) {
    StringBuilder sql = new StringBuilder();
    String tableName = StringUtil.removeSpecialCharAndLower(
      entityDaoVO.getDbTableName() + Constants.FULL_HIST_TABLE_PREFIX
    );
  ...
  public String deleteAttr(CommonEntityDaoVO entityDaoVO) {
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        if (
          dbColumnInfoVO.getHierarchyAttributeIds().get(0).equals(deleteAttrId)
        ) {
          select
            .append(dbColumnInfoVO.getColumnName())
            .append(COMMA_WITH_SPACE);
  ...
  public String createHist(CommonEntityDaoVO entityDaoVO) {
    ...
    insertBuilder
      .append(
        StringUtil.removeSpecialCharAndLower(
          entityDaoVO.getDbTableName() + Constants.PARTIAL_HIST_TABLE_PREFIX
        )
      )
      .append(SPACE);
    ...
    if (dbColumnInfoVOMap != null) {
      ...
      for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
        ...
        compareColumnList.removeIf(
          e -> e.toUpperCase().equalsIgnoreCase(columnName)
        );
        ...
        if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
          ...
          tableColumns.replaceAll(
            e ->
              (e.equalsIgnoreCase(columnName))
                ? "ST_asText(ST_GeomFromGeoJSON(" + columnName + "))"
                : (e.equalsIgnoreCase(columnName + "_idx"))
                  ? "ST_DISKINDEX(ST_asText(ST_GeomFromGeoJSON(" +
                  columnName +
                  ")))"
  ...
  private String generateHbaseTable(String tableName) {
    return StringUtil.removeSpecialCharAndLower(
      tableName.replace(Constants.SCHEMA_NAME, "")
    );
  }
    ...
    SQL sql = new SQL() {
      {
        ...
        INNER_JOIN(
          "(SELECT ID AS LAST_T_ID, CREATED_AT " +
          " FROM " +
          tableName +
          " ) AS LAST_T " +
