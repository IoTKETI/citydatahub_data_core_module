...
import kr.re.keti.sc.dataservicebroker.common.datamapperhandler.BooleanArrayListTypeHandler;
import kr.re.keti.sc.dataservicebroker.common.datamapperhandler.DateArrayListTypeHandler;
import kr.re.keti.sc.dataservicebroker.common.datamapperhandler.FloatArrayListTypeHandler;
import kr.re.keti.sc.dataservicebroker.common.datamapperhandler.IntegerArrayListTypeHandler;
...
public class RdbEntitySqlProviderImpl {
    ...
    SQL sql = new SQL() {
      {
        // 1. 테이블명 설정
        INSERT_INTO(
          Constants.SCHEMA_NAME + ".\"" + entityDaoVO.getDbTableName() + "\""
        );
          ...
          for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
            ...
            if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
              ...
              VALUES(
                ...
                daoAttributeId +
                ", typeHandler=" +
                IntegerArrayListTypeHandler.class.getName() +
                "}::INT[]"
              );
              ...
              VALUES(
                ...
                daoAttributeId +
                ", typeHandler=" +
                FloatArrayListTypeHandler.class.getName() +
                "}::FLOAT[]"
              );
              ...
              VALUES(
                ...
                daoAttributeId +
                ", typeHandler=" +
                DateArrayListTypeHandler.class.getName() +
              ...
              VALUES(
                ...
                daoAttributeId +
                ", typeHandler=" +
                BooleanArrayListTypeHandler.class.getName() +
                "}::BOOLEAN[]"
              );
        ...
        if (dbColumnInfoVOMap != null) {
          ...
          for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
            ...
            if (
              ...
              daoAttributeId.endsWith(
                Constants.COLUMN_DELIMITER + PropertyKey.CREATED_AT.getCode()
              )
            ) {
              SET(
                columnName +
            ...
            if (
              dbColumnType == DbColumnType.TIMESTAMP &&
              daoAttributeId.endsWith(
                Constants.COLUMN_DELIMITER + PropertyKey.MODIFIED_AT.getCode()
              )
            ) {
              SET(
                columnName +
            ...
            if (dbColumnType == DbColumnType.VARCHAR) {
              SET(
                columnName + " = #{" + daoAttributeId + ", jdbcType=VARCHAR}"
              );
            } else if (dbColumnType == DbColumnType.INTEGER) {
              SET(
                columnName + " = #{" + daoAttributeId + ", jdbcType=INTEGER}"
              );
              ...
              SET(
                ...
                ", typeHandler=" +
                DateArrayListTypeHandler.class.getName() +
                ", jdbcType=ARRAY}::TIMESTAMP WITH TIME ZONE[]"
              );
            } else if (dbColumnType == DbColumnType.TIMESTAMP) {
              SET(
                columnName + " = #{" + daoAttributeId + ", jdbcType=TIMESTAMP}"
              );
            } else if (dbColumnType == DbColumnType.GEOMETRY_4326) {
              SET(
                columnName +
  ...
  public String replaceAttrHBase(CommonEntityDaoVO entityDaoVO) {
    throw new UnsupportedOperationException(
      "DynamicRdbSqlProvider not supported 'replaceAttrHBase'"
    );
  }
          ...
          for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
            ...
            if (dbColumnType == DbColumnType.VARCHAR) {
              ...
              SET(
                ...
                ", typeHandler=" +
                DateArrayListTypeHandler.class.getName() +
                ", jdbcType=ARRAY}::TIMESTAMP WITH TIME ZONE[] END"
              );
            } else if (dbColumnType == DbColumnType.TIMESTAMP) {
              SET(
                columnName +
              ...
              SET(
                ...
                " = CASE WHEN " +
                columnName +
                " IS NOT NULL THEN ST_Transform(ST_SetSRID(ST_GeomFromGeoJSON(#{" +
                daoAttributeId +
                "}), 4326), 3857) END"
              );
            } else {
    ...
    SQL sql = new SQL() {
      {
        ...
        if (dbColumnInfoVOMap != null) {
          ...
          VALUES(
            "OPERATION",
            "#{" +
            DataServiceBrokerCode.DefaultAttributeKey.OPERATION.getCode() +
            "}"
          );
        ...
        if (dbColumnInfoVOMap != null) {
          ...
          for (DataModelDbColumnVO dbColumnInfoVO : dbColumnInfoVOMap.values()) {
            ...
            if (dbColumnType == DbColumnType.ARRAY_VARCHAR) {
              ...
              VALUES(
                columnName,
                "ST_SetSRID(ST_GeomFromGeoJSON(#{" + columnName + "}), 4326)"
              );
            } else if (dbColumnType == DbColumnType.GEOMETRY_3857) {
              VALUES(
                columnName,
