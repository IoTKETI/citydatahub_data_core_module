package kr.re.keti.sc.datacoreusertool.security.service;
...
import kr.re.keti.sc.datacoreusertool.security.vo.AccessTokenFormVO;
import kr.re.keti.sc.datacoreusertool.security.vo.RefreshTokenFormVO;
import kr.re.keti.sc.datacoreusertool.security.vo.UserVO;
import kr.re.keti.sc.datacoreusertool.util.ConvertUtil;
import kr.re.keti.sc.datacoreusertool.util.CryptoUtil;
import lombok.extern.slf4j.Slf4j;

/**
 * Class for Data core UI service.
 * @FileName UserToolSecuritySVC.java
...
@Slf4j
@Service
public class UserToolSecuritySVC {
	@Autowired
	 ...
	 * @return			Public key
	 */
	public ResponseEntity<String> getPublicKey(String jwtToken) {
	 ...
	 * @throws JSONException	Throw an exception when an json parsing error occurs.
	 * @throws IOException		Throw an exception when an IO error occurs.
	 */
	public void logout(HttpServletRequest request, HttpServletResponse response) throws JSONException {
