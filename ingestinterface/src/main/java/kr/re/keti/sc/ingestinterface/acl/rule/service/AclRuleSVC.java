package kr.re.keti.sc.ingestinterface.acl.rule.service;
...
import kr.re.keti.sc.ingestinterface.acl.rule.dao.AclRuleDAO;
...
public class AclRuleSVC {
    ...
    public void createAclRule(String requestBody, String requestId, Date eventTime) {
        ...
        try {
            ...
            throw new BadRequestException(IngestInterfaceCode.ErrorCode.INVALID_PARAMETER,
...
//	 			dataModelManager.putDatasetCache(retrieveAclDatasetVO);
    ...
    public void updateAclRule(String to, String requestBody, String requestId, Date eventTime) {
        ...
        if (matcherForUpdate.find()) {
            ...
            if (result == 0) {
                throw new BadRequestException(IngestInterfaceCode.ErrorCode.NOT_EXIST_ID,
                        "Not Exists. id=" + id);
            }
